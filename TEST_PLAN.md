...
- 本节最终须记录冻结工作树的定向 Chromium／WebKit、`npm run check:full`、精确 PR/main CI、发布回执和独立生产回读。桌面合成视口与用户的缺陷录屏都不能替代修复后真实 iPhone Safari／Chrome、安装态 PWA 和 Android Chrome 验收。
