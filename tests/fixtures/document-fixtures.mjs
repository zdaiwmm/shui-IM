...
export async function readerEpub({ badPath = false, encrypted = false, oversized = false, epub2 = false } = {}) {
  ...
  await add('OPS/book.opf', `<package xmlns="http://www.idpf.org/2007/opf" version="${epub2 ? '2.0' : '3.0'}"><metadata xmlns:dc="http://purl.org/dc/elements/1.1/"><dc:title>Quiet Room</dc:title></metadata><manifest><item id="one" href="one.xhtml" media-type="application/xhtml+xml"/><item id="two" href="two.xhtml" media-type="application/xhtml+xml"/><item id="image" href="cover.png" media-type="image/png"/><item id="nav" href="${epub2 ? 'toc.ncx' : 'nav.xhtml'}" ${epub2 ? 'media-type="application/x-dtbncx+xml"' : 'media-type="application/xhtml+xml" properties="nav"'}/></manifest><spine toc="nav"><itemref idref="one"/><itemref idref="two"/></spine></package>`);
  ...
  await add('OPS/two.xhtml', xhtml('<h1>星光</h1><p id="note">星光落在安静的房间里。Needle in an EPUB chapter.</p><table><tr><th>章节</th><th>内容</th></tr><tr><td>二</td><td>夜读</td></tr></table>'));
